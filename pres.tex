...
\begin{document}
\frame{\titlepage 
\includegraphics[height=1cm]{sponsor-wo}\hfill\includegraphics[height=1cm]{uos_grey_large}}

\setbeamertemplate{headline}{
	\vskip25pt % horizontal line
	\vskip-21pt\hspace{2pt}\hfill\includegraphics[height=7mm]{sponsor-wo}\hspace{3.5mm}\includegraphics[height=7mm]{uos_grey_large}\hspace{3.5mm} % logo on the right
}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{5cm}
		\begin{center}
			\includegraphics[width=3.5cm]{hardhat} \vspace{2mm}
			\includegraphics[width=5cm]{ngcm2}
		\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{5cm}
		\begin{center}
			\includegraphics[width=3cm]{grains2} \vspace{1mm}
			
			\includegraphics[width=4cm]{bulk}
		\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{5cm}
		\begin{center}
			\includegraphics[width=4cm]{Ds} \\
			\includegraphics[width=4cm]{Aggregate}
		\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=4.5cm]{coerc} \hspace{2mm}
	\includegraphics[width=4.5cm]{laser} \\
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=4.5cm]{person} \\
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{5cm}
		\begin{center}
			\includegraphics[height=1.25cm]{julia}\\
			\includegraphics[height=1cm]{python}
			\includegraphics[height=1cm]{R} \vspace{14mm}
			\includegraphics[height=1.5cm]{intel}\hspace{0.2cm}
			\includegraphics[height=1.5cm]{nividia}
		\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\column{5cm}
		\includegraphics[width=5cm]{ngcm}
		\column{7cm}
